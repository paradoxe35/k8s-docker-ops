...
external_url 'https://hub.homelab.net'
...
gitlab_rails['smtp_address'] = "mail.homelab.net"
gitlab_rails['smtp_port'] = 587
gitlab_rails['smtp_user_name'] = "gitlab@homelab.net"
gitlab_rails['smtp_password'] = "--------"
gitlab_rails['smtp_domain'] = "mail.homelab.net"
...
gitlab_rails['gitlab_email_from'] = 'gitlab@homelab.net'
gitlab_rails['gitlab_email_display_name'] = 'homelab Gitlab Hub'
...
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     ...
     ## EE only
     group_base: 'cn=groups,cn=accounts,dc=homelab,dc=com'
     admin_group: 'cn=sysadmins,cn=groups,cn=accounts,dc=homelab,dc=com'
     sync_ssh_keys: false
...
registry_external_url 'https://registry-hub.homelab.net'

### Settings used by GitLab application
#
gitlab_rails['registry_enabled'] = true
#gitlab_rails['registry_host'] = "registry-hub.homelab.net"
